...
/*#[derive(Default)]
pub struct MouseEventState<'a> {
    pub mouse_motion_event_reader: EventReader<'a, MouseMotion>,
    pub mouse_wheel_event_reader: EventReader<'a, MouseWheel>,
}*/
...
fn update_input(
    ...
    //motion_events: Res<Input<MouseMotion>>,
    //wheel_events: Res<Input<MouseWheel>>,
) {
